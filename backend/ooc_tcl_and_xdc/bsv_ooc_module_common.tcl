...
synth_design -top $ooc_top -mode out_of_context -flatten_hierarchy none
...
xilinx::designutils::report_failfast -max_paths $max_net_path_num -detailed_reports synth -file $dir_ooc_out/post_synth_failfast.rpt
